...
import { AreaHeader } from '@/components/search/area-header';
import {
  areaLabel,
  AreaSelection,
  AreaSheet,
  DEFAULT_AREA,
  matchesArea,
} from '@/components/search/area-sheet';
import { DateStrip } from '@/components/search/date-strip';
import { FilterFab } from '@/components/search/filter-fab';
import {
  applyFilter,
  countActiveFilters,
  DEFAULT_FILTER,
...
import { ModeToggle, SearchMode } from '@/components/search/mode-toggle';
import { RecruitmentCard } from '@/components/search/recruitment-card';
import { SportSelectButton, SportSheet } from '@/components/search/sport-select';
...
import { dateFromToday } from '@/data/mock-recruitments';
import { useRecruitments } from '@/data/recruitment-store';
import { useTeams } from '@/data/team-store';
import type { Recruitment, Sport } from '@/types/recruitment';
...
function padToColumns(items: Recruitment[]): GridItem[] {
...
interface DateSearchProps {
  ...
  filterOpen: boolean;
  onFilterClose: () => void;
  onFilterApply: (filter: RecruitmentFilter) => void;
}
...
function DateSearch({
  ...
  const dayItems = useMemo(
    ...
    [recruitments, selectedDate, area, sport],
  );
