...
import { OptionSheet, SheetOption } from '@/components/post/option-sheet';
import { VenueSheet } from '@/components/post/venue-sheet';
...
import { addRecruitment } from '@/data/recruitment-store';
...
export default function PostScreen() {
  ...
  const [type, setType] = useState<RecruitmentType | null>(null);
