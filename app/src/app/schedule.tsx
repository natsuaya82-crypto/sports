...
import { Brand, Palette, RecruitmentTypeColors, Spacing } from '@/constants/theme';
import { useAppTheme, useThemedStyles } from '@/contexts/theme-context';
import { mockSchedule, ScheduleEntry } from '@/data/mock-schedule';
import { RecruitmentTypeLabels } from '@/types/recruitment';
...
export default function ScheduleScreen() {
  ...
  const renderItem = ({ item }: { item: ScheduleEntry }) => (
    <Pressable
      ...
      onPress={() =>
        item.recruitmentId &&
        router.push({ pathname: '/recruitment/[id]', params: { id: item.recruitmentId } })
      }>
      ...
      <View style={styles.cardBody}>
        <View style={styles.badgeRow}>
          <View
            ...
            <Text style={styles.typeText}>{RecruitmentTypeLabels[item.type]}</Text>
          </View>
          <View
            style={[
              styles.statusBadge,
