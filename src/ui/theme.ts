 ...
 *
 * prototypeが色を決めているのは4種類だけ。残りの selection / tournament /
 * event はまだ画面が無く、色はユーザーが決めるもの(CLAUDE.md 第7章)なので
 * ここでは持たない。指示があるまでは tagText へ倒す。
 */
const OpportunityKindColors: Partial<Record<OpportunityKind, string>> = {
  individual_join: '#E5484D',
  team_member: '#3B82F6',
  friendly_match: '#30A46C',
  practice: '#F76B15',
};

export function getOpportunityKindColor(
